...
-- Q2. Customers who used a discount and spent >= average purchase amount
...
-- Q7. Segment customers into New, Returning, Loyal based on previous_purchases
...
-- Q9. Are repeat buyers (previous_purchases > 5) likely to subscribe?
SELECT subscription_status,
